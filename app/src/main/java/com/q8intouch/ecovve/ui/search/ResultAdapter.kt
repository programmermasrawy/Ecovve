...
import com.q8intouch.ecovve.network.model.EcovveCafeMenu
import kotlinx.android.synthetic.main.row_menu_cafe.view.*

class ResultAdapter (
    val items: List<EcovveCafeMenu.Data.Suborder>, val context: Context,
    ...
    override fun onBindViewHolder(holder: ViewHolderitem, position: Int) {
        holder.txtShopName.setText(""+items.get(position).item.get(0).buyOneGetOneOffer)
