...
class ChoicesAdapter(val items: List<EcovveShowExtra.Data.Choice?>?, val context: Context, val itemClickListener: ControlsListeners)
    : RecyclerView.Adapter<ViewHolderCo>() {
...
//        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderCo {
        return ViewHolderCo(LayoutInflater.from(context).inflate(R.layout.extra_ui_choices, parent, false))
    }
...
class ViewHolderCo(view: View) : RecyclerView.ViewHolder(view) {
